    ...
    <div className="flex space-x-2 p-5">
        ...
        <div className="flex flex-1 items-center pl-2 ">
            <form className="flex-1 flex flex-col">
                <input ref={imageInputRef} value={input} onChange={e => setInput(e.target.value)} className="h-24 w-full text-xl outline-none placeholder:text:xl" type="text" placeholder="What's Happening?"/>
                ...
                {imageUrlBoxIsOpen && (
                    <form className="mt-5 flex rounded-lg bg-[#00ADED]/80 py-2 px-4">
                        ...
                        <button onClick={e => addImageToTweet} type="submit" className="font-bold text-white">Add Image</button>
                    </form>
                )}
            </form>
        </div>

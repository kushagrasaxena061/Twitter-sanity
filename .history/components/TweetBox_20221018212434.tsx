            ...
            <form className="flex-1 flex flex-col">
                ...
                <div className="flex items-center ">
                    <div className="flex flex-1 space-x-2 text-[#00ADED]">
                        <PhotographIcon className="h-5 w-5 space-x-1"/>
                        <SearchCircleIcon className="h-5 w-5 space-x-1"/>
                        <EmojiHappyIcon className="h-5 w-5 space-x-1"/>
                        <CalendarIcon className="h-5 w-5 space-x-1"/>
                        <LocationMarkerIcon className="h-5 w-5 space-x-1"/>
                    </div>
